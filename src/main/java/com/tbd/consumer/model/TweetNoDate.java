...
public class TweetNoDate {
    ...
    public TweetNoDate(Long id, String name, String text, Integer like, Integer followers, GeoLocation geoLocation, String userLocation, Integer retweet) {
        this.id = id;
        this.name = name;
        this.text = text;
        this.like = like;
